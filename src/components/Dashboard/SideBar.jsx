...
export default function SideBar({ username, url }) {
  ...
  return (
    <div className="bg-first-color p-0">
      ...
      >
        <span className="my-auto fs-5">
          <i className="bi bi-building"></i>
        </span>
        <span className="my-auto ms-2 fs-5 d-none d-lg-inline">EMPRESA</span>
      </div>
      <div id="profile" className="d-flex flex-column text-center mt-3">
        <a href="#" className="">
          <img
            src={avatarUrl}
            alt={username}
        ...
        <span className="lg-fs mt-0">
          <strong>{username}</strong>
        </span>
        <span className="text-emphasis-color sm-fs">
          <strong>Admin</strong>
        </span>
      </div>
      <div id="menu" className="mt-3 min-vh-100">
        ...
        <div className="d-flex flex-column align-items-center align-items-sm-center px-1 pt-2">
          <ul className="nav nav-pills navbar-dark flex-column mb-sm-auto mb-0 align-items-sm-start">
            <li>
              <Link
                className="nav-link text-color text-decoration-none align-middle p-1"
                to="new_structure"
              >
        ...
        <span className="sm-fs ms-4 text-start text-muted">
          Corte y Plegado
        </span>
        <div className="d-flex flex-column align-items-center align-items-sm-center px-1 pt-2">
          <ul className="nav nav-pills navbar-dark flex-column mb-sm-auto mb-0 align-items-sm-start">
            ...
            <li className="">
              <a
                href="#"
                className="nav-link text-color text-decoration-none align-items-middle p-1"
                title="Pedido pendientes"
              >
                <i className="lg-fs bi bi-list-task"></i>
                <span className="sm-fs ms-2 d-none d-lg-inline">
                  Pendientes
                </span>
              </a>
            </li>
        ...
        <span className="sm-fs ms-4 text-start text-muted">Tablas</span>
        <div className="d-flex flex-column align-items-center align-items-sm-center px-1 pt-2">
          <ul className="nav nav-pills navbar-dark flex-column mb-sm-auto mb-0 align-items-sm-start">
            <li className="">
              <Link
              ...
              >
                <i className="lg-fs bi bi-list-task"></i>
                <span className="sm-fs ms-2 d-none d-lg-inline">Perfil C</span>
              </Link>
            </li>
            <li>
              <Link
